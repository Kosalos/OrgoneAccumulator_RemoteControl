void  outUpdateISR_PULSAR_TWIN(void) {
...
//  o4.phaseOld = o4.phase;
 ...
 o1.phase = o1.phase + o1.phase_increment;
      ...
      if ((unsigned)o4.phase < (unsigned)(o1.phase_increment<<1)) {
       o5.phase = (uint32_t)((o2.phase_increment * o4.phase) >> Temporal_Shift_CZ);
    o6.phase = (uint32_t)((o6.phase_increment * o4.phase) >> Temporal_Shift_CZ);
      }
      o1.phaseOld = o1.phase;
...
void  outUpdateISR_WAVE_TWIN(void) {
  ...
  switch (oscMode) {
    ...
    case 1://-------------------------------------------CZ MODE OSCILLATORS-----------------------------------------------
      ...
      if ((unsigned)o3.phase < (unsigned)(o1.phase_increment<<1))
        o4.phase = (uint32_t)((o4.phase_increment * o3.phase) >> Temporal_Shift_CZ);
